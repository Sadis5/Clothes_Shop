      ...
      <div className="header container">
        <div className="header_top">
          ...
          <div style={{
            ...
            <ButtonIcon image={Profile} handleClick={F}/>
            <ButtonIcon image={Liked} handleClick={F}/>
            <ButtonIcon image={Basket} handleClick={F}/>
          </div>
        </div>
        ...
        <nav className="header_bottom">
          <ul className="link_head">
            ...
            <li className="link"><Link>Full Set</Link></li>
